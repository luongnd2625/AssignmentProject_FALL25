    ...
    <body>
            ...
            <nav class="navigation">
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <a href="userRequest" style="background: rgba(255,255,255,0.1);">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <h2 class="mb-4"><i class="fa-solid fa-file-pen me-2"></i>Tạo đơn xin nghỉ phép</h2>
                    ...
                    <div class="card-body">
                        ...
                        <form action="userRequest" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="title" name="title" placeholder="Ví dụ: Xin nghỉ phép đi du lịch" required>
                            </div>
                            
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="fromDate" class="form-label">Nghỉ từ ngày</label>
                                    <input type="date" class="form-control" id="fromDate" name="fromDate" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="toDate" class="form-label">Đến hết ngày</label>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="reason" name="reason" rows="4" placeholder="Vui lòng nêu rõ lý do xin nghỉ..." required></textarea>
                            </div>
