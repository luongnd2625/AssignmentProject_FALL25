    ...
    <body>
        ...
        <header>
            <nav class="navigation">
                ...
                <a href="adminRequestManagement" style="background: rgba(255,255,255,0.1);"><i class="fa-solid fa-file-invoice me-2"></i>Quản lí đơn</a>
        ...
        <div class="content">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="adminRequestManagement" method="POST">
