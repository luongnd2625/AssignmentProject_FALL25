    ...
    <head>
        ...
        <style>
            ...
            * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Be Vietnam Pro', sans-serif; }
            ...
            .agenda-table { table-layout: fixed; border-color: #dee2e6; }
            .agenda-table th, .agenda-table td { vertical-align: top; height: 120px; padding: 8px; }
            .agenda-table thead th { height: auto; background-color: #343a40; color: white; text-align: center; vertical-align: middle; }
            .day-number { font-size: 1.2em; font-weight: 600; color: #6c757d; }
            .on-leave { display: block; background-color: #dc3545; color: white; padding: 2px 6px; border-radius: 4px; font-size: 0.8em; margin-top: 4px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
